...
public class SwaggerConfig {
    ...
    private static final String BASE_PACKAGE = "com.slbruno.carrental";
    private static final String API_TITLE = "Car Rental API";
    private static final String API_DESCRIPTION = "REST API for car rental";
